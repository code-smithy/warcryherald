...
The Phase 8 activity migration adds `activity_log`, a campaign-wide chronicle
generated by database triggers from campaign members, warbands, warband
fighters, battle events, and warband journal entries. Campaign members can read
their campaign activity through RLS; normal frontend clients cannot write
activity entries directly.
